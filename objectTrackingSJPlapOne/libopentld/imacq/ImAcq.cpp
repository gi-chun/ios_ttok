...
//        cvSetCaptureProperty( imAcq->capture, CV_CAP_PROP_FRAME_HEIGHT, 480); //480 , 360
        
        cvSetCaptureProperty( imAcq->capture, CV_CAP_PROP_FRAME_WIDTH, 1280);
        cvSetCaptureProperty( imAcq->capture, CV_CAP_PROP_FRAME_HEIGHT, 720);
        //gclee end
